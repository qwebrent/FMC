                ...
                <div class="card-body">
                    <div class="container">
                        <div class="text-center">
                            <p class="card-text text-white">Your payment confirmation will be reviewed by our team.
                            </p>
                            <p class="card-text text-white">Thank you for choosing FMC Catering Services</p>
                            <p class="card-text text-white">For questions contact us at: 0905 368 1574</p>
