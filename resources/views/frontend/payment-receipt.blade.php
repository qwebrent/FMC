                            ...
                            <div class="invoice-header">
                                <div class="invoice-from">
                                    ...
                                    <address class="m-t-5 m-b-5">
                                        <strong class="text-inverse">FMC Catering Services</strong><br>
                                        162, Cpammms Ville Balayhangin<br>
                                        Calauan, Laguna<br>
                                        0905 368 1574<br>
                                    </address>
                                </div>
                                <div class="invoice-to">
                                    <small>to</small>
                                    <address class="m-t-5 m-b-5">
                                        <strong class="text-inverse">{{ $details->fullname }}</strong><br>
                                        {{ $details->email }}<br>
                                ...
                                <div class="invoice-date">
                                    <small>-</small>
                                    <div class="date text-inverse m-t-5">Date Now</div>
                                    <div class="invoice-detail">
                                        {{ $details->referenceNum }}<br>
                                    </div>
                                </div>
                            </div>
                            <!-- end invoice-header -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-invoice">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <span class="text-inverse">{{ $details->package_num }}</span><br>
                                                </td>
                                                <td class="text-center">{{ $details->event_type }}</td>
                                                <td class="text-center">{{ $details->event_date }}</td>
